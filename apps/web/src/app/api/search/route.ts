...
type ItalianRow={_id:string;provisionId:string;title:string;provisionType?:string;issuer?:string;status?:string;summary?:string;text?:string;effectiveFrom?:string;sourceTitle?:string;officialUrl?:string};
